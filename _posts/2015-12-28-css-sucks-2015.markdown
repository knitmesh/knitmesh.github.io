...
### [Watching Fullscreen →](https://jingh.top/css-sucks-2015/)
...
这个 Web Slides 开源在[我的 Github 上](https://github.com/knitmesh/css-sucks-2015)，欢迎你帮助我完善这个展示文稿，你可以给我提 issue，可以 fork & pull request。如果它能帮助到你了，希望你还能不吝啬 star 一下这个项目
