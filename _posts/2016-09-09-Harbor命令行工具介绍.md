...
项目地址: `https://github.com/jingh/harborclient`
...
```bash
git clone https://github.com/jingh/harborclient
```
...
+---------+----------+----------------------+--------------+-------------+
|    3    | jingh | jingh@example.com |   jingh   |      -      |
...
RESP BODY: {"username": "jingh", "comment": "", "update_time": "2016-09-07T13:05:38Z", "reset_uuid": "", "user_id": 3, "realname": "jingh", "deleted": 0, "creation_time": "2016-09-07T13:05:38Z", "role_id": 0, "has_admin_role": 0, "role_name": "", "password": "", "Salt": "c5a5f1de-74fb-11e6-a5b4-0242ac130004", "email": "jingh@example.com"}
```
...
| 2016-09-07T13:25:41Z |  admin   |   create  |      jingh/       |
